...
export type SimpleCollectionFieldsFragment = { __typename?: 'Collection', id: string, name: string, slug: string, featuredAsset?: { __typename?: 'Asset', preview: string } | null, productVariants: { __typename?: 'ProductVariantList', items: Array<(
      { __typename?: 'ProductVariant' }
      & { ' $fragmentRefs'?: { 'SimpleProductVariantFieldsFragment': SimpleProductVariantFieldsFragment } }
    )> } } & { ' $fragmentName'?: 'SimpleCollectionFieldsFragment' };

export type SimpleProductFieldsFragment = { __typename?: 'Product', id: string, name: string, slug: string, description: string, featuredAsset?: { __typename?: 'Asset', preview: string } | null, variants: Array<{ __typename?: 'ProductVariant', id: string, price: number, currencyCode: CurrencyCode }> } & { ' $fragmentName'?: 'SimpleProductFieldsFragment' };

export type SimpleProductVariantFieldsFragment = { __typename?: 'ProductVariant', id: string, price: number, currencyCode: CurrencyCode, name: string, product: { __typename?: 'Product', id: string, name: string, slug: string, description: string, featuredAsset?: { __typename?: 'Asset', preview: string } | null, collections: Array<{ __typename?: 'Collection', id: string, name: string }> } } & { ' $fragmentName'?: 'SimpleProductVariantFieldsFragment' };
