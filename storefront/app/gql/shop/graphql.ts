...
export type GetBundleQuery = { __typename?: 'Query', collection?: (
    { __typename?: 'Collection' }
    & { ' $fragmentRefs'?: { 'SimpleBundleFieldsFragment': SimpleBundleFieldsFragment } }
  ) | null };
