...
export class AddWishlistPlugin1773338383664 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "shipping_method" DROP COLUMN "customFieldsDigitalfulfilmentonly"`, undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "shipping_method" ADD "customFieldsDigitalfulfilmentonly" boolean DEFAULT true`, undefined);
