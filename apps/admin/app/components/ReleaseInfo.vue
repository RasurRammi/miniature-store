...
import { type CollectionInput, useSubmitCollection } from '~/composables/useSubmitCollection'
...
import {DrawerLayout, FlexibleGrid} from "@miniature-store/shared/components";
...
const mayEdit = computed(() => !!user.data.value)
