import type {
    SimpleAssetFragment, SimpleCollectionFieldsFragment, SimpleFacetFieldsFragment,
    SimpleFacetValueFieldsFragment, SimpleProductFieldsFragment, SimpleProductVariantFieldsFragment
} from "~/gql/graphql";
